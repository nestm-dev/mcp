	...
	resolve: {
		alias: [
			...
			},
			{
				...
				replacement: new URL("../../packages/mcp-auth/src/stores/index.ts", import.meta.url)
					.pathname,
			},
			{
				find: /^@nestm\/mcp-auth$/,
			...
			},
			{
				...
				replacement: new URL("../../packages/mcp-conformance/src/index.ts", import.meta.url)
					.pathname,
			},
			{
			...
			},
			{
				...
				replacement: new URL("../../packages/mcp-server/src/auth/index.ts", import.meta.url)
					.pathname,
			},
			{
